    ...
    <section class="my-10" style="font-family: playfair-display">
        <div class="container mx-auto px-4">
            <div class="flex flex-col items-center">
                <h2 data-aos="fade-up" data-aos-delay="100" class="text-3xl font-bold text-center text-gray-900">Tentang
                    Kampung Kendung</h2>
                <hr data-aos="fade-up" data-aos-delay="100"
                    class="w-20 h-1 mt-1 border-0 rounded-full mr-80 bg-blue-400" />
            </div>
            <p data-aos="fade-up" data-aos-delay="200" class="text-xl mt-5 text-gray-600 text-center">Sejarah Kampung
                Kendung</p>
        </div>
